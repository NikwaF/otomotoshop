		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="index.html">Home</a></span> / <span><?= $breadcrumb; ?></span></p>
					</div>
				</div>
			</div>
		</div>
		              	...
		              	<div class="row">
			               ...
			               <div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-group ">
										<div class="radio ">
										<input type="radio" id="krmkelain" name="krmkelain" value="1"> Kirim Ke Alamat Lain
										</div>
									</div>
								</div>


								<div id="alamatlainyah" class="col-md-12 hidden">
									<div class="form-group">
										<label for="alamatlain">Alamat Lain</label>
										<textarea class="form-control" name="alamatlain" id="alamatlain" cols="30" rows="10"></textarea>
									</div>
								</div>
		               </div>
		            </form>
					...
					<div class="col-lg-4">
						<div class="row">
						   ...
						   <div class="col-md-12">
								<div class="cart-detail">
									<h2>Metode Order</h2>
									<div class="form-group">
										<a style="font-size:18px;" class="btn btn-primary" href="<?= site_url('cart_oto/checkoutantar') ?>"> Antar</a>
									</div>
									<div class="form-group">
										<a style="font-size:18px;" class="btn btn-success" href="<?= site_url('cart_oto/checkout') ?>"> Jemput</a>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 text-center">
								<p><a id="ordergan" style="border-radius:10px;padding-right:50px;padding-left:50px;padding-top:20px;padding-bottom:20px;background-color:#c1bfbf;color:white;font-size:20px;" href="<?= site_url('cart_oto/checkout_record'); ?>" class="btn order">Order</a></p>
							</div>
						</div>
					</div>
				</div>
