					...
					<div class="col-lg-4">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<p><a id="ordergan" style="border-radius:10px;padding-right:50px;padding-left:50px;padding-top:20px;padding-bottom:20px;background-color:#c1bfbf;color:white;font-size:20px;" href="<?= site_url('suksesantar'); ?>" class="btn order">Order</a></p>
							</div>
						</div>
					</div>
				</div>
