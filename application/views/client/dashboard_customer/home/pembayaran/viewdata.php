...
<?php endforeach; ?>
  ...
  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#tambah">Tambah Bukti Pembayaran</button>
  ...
  <div id="tambah" class="modal fade" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <?= form_open_multipart('Customer_dashboard/tambahPembayaran'); ?>
        <div class="modal-body">
          <div class="form-group">
            <label class="control-label" for="nm_brg">Kode Unik</label>
            <select class="form-control" id="kode_unik" name="kode_unik">
              <?php foreach ($kodeunik as $kode) : ?>
              <option value="<?= $kode['kode_unik'] ;?>"><?=$kode['kode_unik'];?></option>
              <?php endforeach; ?>
            </select>
            <!-- <input type="text" name="kode_unik" class="form-control" id="kode_unik" required> -->
          </div>
        </div>
        <div class="form-group">
          <label class="control-label" for="nm_brg">Bukti Transfer</label>
          <?= form_upload('gambar_trf','','class="form-control"'); ?>
        </div>
        <div class="modal-footer">
          <button type="reset" class="btn btn-danger">Reset</button>
          <?= form_submit('add_bukti','Kirim Bukti','class="btn btn-success"'); ?>
          <?= form_close(); ?>
        </div>
      </div>
    </div>
...
<div class="modal fade" id="hapus<?=$bukti['pembayaran_id'];?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" method="post" action="<?= site_url('customer_dashboard/hapusbuktipembayaran') ?>">
        <div class="modal-body">
