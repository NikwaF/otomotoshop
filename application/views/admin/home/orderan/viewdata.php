          ...
          foreach ($orderans as $orderan): ?>
                <tr>
                    ...
                    <td align="center" height="5" style="overflow:hidden;">
                        ...
                        <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#lihat<?=$orderan['orders_id'];?>" ><i class="fa fa-eye" aria-hidden="true"></i> View</button>
                        <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#edit<?=$orderan['orders_id'];?>" ><i class="fa fa-edit"></i> Edit</button>
                      <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#hapus<?=$orderan['orders_id'];?>" ><i class="fa fa-edit"></i> Hapus</button>
                      </a>
                    </td>
                </tr>
          <?php endforeach; ?>
